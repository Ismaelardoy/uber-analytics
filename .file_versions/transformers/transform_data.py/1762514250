...
def transform(zonedata, tripdata, *args, **kwargs):
    """
    Load data from the Parquet paths, 
    apply the transformation using PySpark, and save the result
    """
    ...
    print(f"📂 Reading zones from: {path_zones}")
    print(f"📂 Reading trips from: {path_tripdata}")
